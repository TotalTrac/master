...
GO
CREATE PROCEDURE [dbo].[colpenn_MailRecordsGetByPrintKeyByMailDateRange]
...
BEGIN
	...
	WHERE
		(@PrintKey IS NULL OR MAILRECORD_PRINTKEY = @PrintKey)
		AND (@From IS NULL OR MAILRECORD_MAILDATE >= @From)
