...
GO
CREATE PROCEDURE [dbo].[colpenn_SourceCodesGetCountsByBatchDateRange] (  
  @Effort				char(1)	= NULL
...
BEGIN
	...
	(
        ...
        WHERE
			...
			AND (@DateFrom IS NULL OR m.MAILRECORD_BATCHDATE >= @DateFrom) 
        ...
        FROM 
         ...
         WHERE
			...
			AND (@DateFrom IS NULL OR r.REJECTRECORD_BATCHDATE >= @DateFrom) 
