...
GO
CREATE PROCEDURE [dbo].[colpenn_SourceCodesGetCountsByTransactionDateRange] (  
  @Effort				char(1)	= NULL
...
BEGIN
	...
	SELECT
		COUNT(*) AS [COUNT] 				
		, t.EFFORT AS EFFORT
		, CASE @SourceCode1  WHEN 1 THEN t.SOURCECODE1 END AS SOURCECODE1
		, CASE @SourceCode2  WHEN 1 THEN t.SOURCECODE2 END AS SOURCECODE2
		, CASE @SourceCode3  WHEN 1 THEN t.SOURCECODE3 END AS SOURCECODE3
		, CASE @SourceCode4  WHEN 1 THEN t.SOURCECODE4 END AS SOURCECODE4
		, CASE @SourceCode5  WHEN 1 THEN t.SOURCECODE5 END AS SOURCECODE5
		, CASE @SourceCode6  WHEN 1 THEN t.SOURCECODE6 END AS SOURCECODE6
		, CASE @SourceCode7  WHEN 1 THEN t.SOURCECODE7 END AS SOURCECODE7
		, CASE @SourceCode8  WHEN 1 THEN t.SOURCECODE8 END AS SOURCECODE8
		, CASE @SourceCode9  WHEN 1 THEN t.SOURCECODE9 END AS SOURCECODE9
		, CASE @SourceCode10 WHEN 1 THEN t.SOURCECODE10 END AS SOURCECODE10
	...
	(
		...
		, CASE @SourceCode1  WHEN 1 THEN m.MAILRECORD_SOURCECODE1 END AS SOURCECODE1
			, CASE @SourceCode2  WHEN 1 THEN m.MAILRECORD_SOURCECODE2 END AS SOURCECODE2
			, CASE @SourceCode3  WHEN 1 THEN m.MAILRECORD_SOURCECODE3 END AS SOURCECODE3
			, CASE @SourceCode4  WHEN 1 THEN m.MAILRECORD_SOURCECODE4 END AS SOURCECODE4
			, CASE @SourceCode5  WHEN 1 THEN m.MAILRECORD_SOURCECODE5 END AS SOURCECODE5
			, CASE @SourceCode6  WHEN 1 THEN m.MAILRECORD_SOURCECODE6 END AS SOURCECODE6
			, CASE @SourceCode7  WHEN 1 THEN m.MAILRECORD_SOURCECODE7 END AS SOURCECODE7
			, CASE @SourceCode8  WHEN 1 THEN m.MAILRECORD_SOURCECODE8 END AS SOURCECODE8
			, CASE @SourceCode9  WHEN 1 THEN m.MAILRECORD_SOURCECODE9 END AS SOURCECODE9
			, CASE @SourceCode10 WHEN 1 THEN m.MAILRECORD_SOURCECODE10 END AS SOURCECODE10
        ...
        WHERE 
			...
			AND (@DateFrom IS NULL OR m.MAILRECORD_TRANSACTIONDATE >= @DateFrom) 
			AND (@DateTo IS NULL OR m.MAILRECORD_TRANSACTIONDATE <= @DateTo)
        ...
        FROM 
         ...
         WHERE
			...
			AND (@DateFrom IS NULL OR r.REJECTRECORD_TRANSACTIONDATE >= @DateFrom) 
