...
GO
CREATE PROCEDURE [dbo].[colpenn_SummaryCountsGetByTransactionDateRangePaged] (
	@Effort			char(1)
	, @From			datetime	= NULL
	, @To			datetime	= NULL  
	, @Page			int
