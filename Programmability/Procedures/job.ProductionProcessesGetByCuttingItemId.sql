...
CREATE PROCEDURE [job].[ProductionProcessesGetByCuttingItemId]
	@Id int
AS
...
FROM
  ...
  INNER JOIN job.CuttingProductionProcessGroups ippg ON ippg.ProcessId = pp.Id
WHERE
	ippg.CuttingItemId = @Id
