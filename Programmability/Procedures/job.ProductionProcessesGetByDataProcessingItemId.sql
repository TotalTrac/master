...
CREATE PROCEDURE [job].[ProductionProcessesGetByDataProcessingItemId]
	@Id int
AS
...
FROM
  ...
  INNER JOIN job.DataSetupProcessGroups dspg ON dspg.ProcessId = pp.Id
WHERE
	dspg.DataProcessingItemId = @Id
