...
CREATE PROCEDURE [messaging].[InstantMessagesGetLatestUnreadBySenderUserIdAndRecipientUserIdPaged]
	@SenderId INT,
  @RecipientId INT,
  @PageNumber INT = 1,
  @PageSize   INT = 10
...
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
  ...
  (
    SELECT Id
      ...
      WHERE
	      (([RecipientUserId] = @RecipientId AND SenderUserId = @SenderId) OR ([RecipientUserId] = @SenderId AND SenderUserId = @RecipientId)) AND (im.IsRead = 0 OR im.IsRead IS NULL)
      ORDER BY Id DESC
