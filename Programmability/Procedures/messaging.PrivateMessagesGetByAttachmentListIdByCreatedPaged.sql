...
GO
--region [messaging].[PrivateMessagesGetByAttachmentListIdByCreatedPaged]

------------------------------------------------------------------------------------------------------------------------
-- Generated By:   dlaub using CodeSmith 6.0.0.0
-- Template:       StoredProcedures.cst
-- Procedure Name: [messaging].[PrivateMessagesGetByAttachmentListIdByCreatedPaged]
-- Date Generated: Wednesday, June 7, 2017
------------------------------------------------------------------------------------------------------------------------


CREATE PROCEDURE [messaging].[PrivateMessagesGetByAttachmentListIdByCreatedPaged]
	@Id int
,
    @From DATETIME,
    @To DATETIME,
