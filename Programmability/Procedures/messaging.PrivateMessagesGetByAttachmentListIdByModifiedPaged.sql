...
GO
--region [messaging].[PrivateMessagesGetByAttachmentListIdByModifiedPaged]

------------------------------------------------------------------------------------------------------------------------
-- Generated By:   dlaub using CodeSmith 6.0.0.0
-- Template:       StoredProcedures.cst
-- Procedure Name: [messaging].[PrivateMessagesGetByAttachmentListIdByModifiedPaged]
-- Date Generated: Wednesday, June 7, 2017
------------------------------------------------------------------------------------------------------------------------


CREATE PROCEDURE [messaging].[PrivateMessagesGetByAttachmentListIdByModifiedPaged]
	@Id int
,
    @From DATETIME,
    @To DATETIME,
