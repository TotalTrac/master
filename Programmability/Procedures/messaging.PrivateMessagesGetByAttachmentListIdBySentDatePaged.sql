...
GO
--region [messaging].[PrivateMessagesGetByAttachmentListIdBySentDatePaged]

------------------------------------------------------------------------------------------------------------------------
-- Generated By:   dlaub using CodeSmith 6.0.0.0
-- Template:       StoredProcedures.cst
-- Procedure Name: [messaging].[PrivateMessagesGetByAttachmentListIdBySentDatePaged]
-- Date Generated: Wednesday, June 7, 2017
------------------------------------------------------------------------------------------------------------------------


CREATE PROCEDURE [messaging].[PrivateMessagesGetByAttachmentListIdBySentDatePaged]
	@Id int
,
    @From DATETIME,
    @To DATETIME,
...
;WITH pg AS
 ...
 AND SentDate BETWEEN @From AND @To
      ORDER BY Id
