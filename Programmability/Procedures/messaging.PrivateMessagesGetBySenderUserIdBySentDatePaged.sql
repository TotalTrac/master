...
GO
--region [messaging].[PrivateMessagesGetBySenderUserIdBySentDatePaged]

------------------------------------------------------------------------------------------------------------------------
-- Generated By:   dlaub using CodeSmith 6.0.0.0
-- Template:       StoredProcedures.cst
-- Procedure Name: [messaging].[PrivateMessagesGetBySenderUserIdBySentDatePaged]
-- Date Generated: Wednesday, June 7, 2017
------------------------------------------------------------------------------------------------------------------------


CREATE PROCEDURE [messaging].[PrivateMessagesGetBySenderUserIdBySentDatePaged]
	@Id int
,
    @From DATETIME,
    @To DATETIME,
