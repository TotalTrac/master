...
CREATE PROCEDURE [messaging].[PrivateMessagesGetTrashBySenderUserIdPaged]
	@Id int,
    @PageNumber INT = 1,
    @PageSize   INT = 10
AS
...
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
  ...
  WHERE 	sub.SenderUserId = @Id AND (sub.IsTrashSender = 1)
...
SELECT COUNT(pm.Id) AS TotalRows FROM messaging.PrivateMessages pm
 WHERE 	pm.SenderUserId = @Id AND (pm.IsTrashSender = 1)
--endregion
GO